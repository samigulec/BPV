...
<div class="col-lg-6">
<span class="logo">Gulec</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">9012676@student.tcrmbo.nl</a><br /><br />
...
<a href="https://www.skytrip.nl/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="sami gulec" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sami Gulec</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+310633311684</h4>
		<h4 style="font-family:'typo' ">9012676@student.tcrmbo.nl</h4>
		<h4 style="font-family:'typo' ">Software developers student</h4></div></div>
		</p>
      </div>
